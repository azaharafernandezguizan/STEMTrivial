  ...
  (this.define || function(N, O) {
    ...
    (function b(q, v, h) {
      ...
      4: [function(q, v, h) {
        ...
        function k(f, g, w, a) {
          a || (p("boolean" === typeof w, "missing or invalid endian"), p(void 0 !== g && null !== g, "missing offset"), p(g + 1 < f.length, "Trying to read beyond buffer length"));
          a = f.length;
          if (!(g >= a))
            return w ? (w = f[g], g + 1 < a && (w |= f[g + 1] << 8)) : (w = f[g] << 8, g + 1 < a && (w |= f[g + 1])), w;
        }
        function n(f, g, a, c) {
          ...
          if (!(g >= c)) {
            var w;
            a ? (g + 2 < c && (w = f[g + 2] << 16), g + 1 < c && (w |= f[g + 1] << 8), w |= f[g], g + 3 < c && (w += f[g + 3] << 24 >>> 0)) : (g + 1 < c && (w = f[g + 1] << 16), g + 2 < c && (w |= f[g + 2] << 8), g + 3 < c && (w |= f[g + 3]), w += f[g] << 24 >>> 0);
            return w;
          }
        }
        function d(f, g, w, a) {
          a || (p("boolean" === typeof w, "missing or invalid endian"), p(void 0 !== g && null !== g, "missing offset"), p(g + 1 < f.length, "Trying to read beyond buffer length"));
          if (!(g >= f.length))
            return f = k(f, g, w, !0), f & 32768 ? -1 * (65535 - f + 1) : f;
        }
        function a(f, g, w, a) {
          a || (p("boolean" === typeof w, "missing or invalid endian"), p(void 0 !== g && null !== g, "missing offset"), p(g + 3 < f.length, "Trying to read beyond buffer length"));
          if (!(g >= f.length))
        ...
        function L(f) {
          for (var g = [],
            ...
            if (127 >= c)
              g.push(f.charCodeAt(a));
            else {
              var b = a;
              55296 <= c && 57343 >= c && a++;
              c = encodeURIComponent(f.slice(b, a + 1)).substr(1).split("%");
      ...
      19: [function(q, v, h) {
        (function(b, e) {
          ...
          function d(a, b) {
            ...
            return d && /^\/\w:/.test(e) ? (d += "/", d + C.resolve(c.slice(d.length), b).replace(/\\/g, "/")) : d + C.resolve(c.slice(d.length), b);
          }
          function a(a) {
            var b = G[a.source];
            if (!b) {
